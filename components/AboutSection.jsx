        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
          <div className="md:w-1/2 ">
            ...
            <p>
              ...
              <span className="font-bold text-teal-500">{" driven"}</span> full-stack web developer
              based in West Palm Beach, FL.
            </p>
            <br />
            <p>
              I have an exceptional ability to learn and<span className="font-bold text-teal-500">{" collaborate"}</span> in rapid changing environments and compositions. I have successfully completed bootcamp structured courses, become proficient in HTML , Javascript, CSS, Node.js, React.js, Three.js and much more. I am eager to obtain a software engineering position, tackle web development/design challenges, and achieve lasting impacts on user experience.
            </p>
            <br/>
            <p>
              ...
              always open to new<span className="font-bold text-teal-500">{" opportunities"}</span>. 🙂
            </p>
          </div>
